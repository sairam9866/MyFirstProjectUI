var FutureRecordTabPO = function(){

    var FutureRecordsButton=element(by.xpath("//button[@routerlink='/future-records']"));
    var FutureRecordsPage=element(by.xpath("//*[@class='breadcrum']"));
    ...
    this.isFutureRecordsTabButtonAvailable = function() {
        return FutureRecordsButton.isPresent();
    };
    ...
    this.isFutureRecordsTabPageDisplayed = function() {
        return FutureRecordsPage.isPresent();
    };
...
module.exports = new FutureRecordTabPO();